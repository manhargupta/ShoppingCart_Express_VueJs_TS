...
*/
var db = new sequelize_1.default('shpcart', 'manhargupta', 'password', {
    host: 'localhost',
    dialect: 'mysql',
    pool: {
        max: 5,
...
var productAttr = {
    ...
    stock: sequelize_1.default.INTEGER,
};
var Products = db.define('product', productAttr);
var vendorAttr = {
    vid: {
        type: sequelize_1.default.INTEGER,
        primaryKey: true,
    ...
    mobile: sequelize_1.default.STRING
};
var Vendor = db.define('vendor', vendorAttr);
var userAttr = {
    id: {
        type: sequelize_1.default.INTEGER,
        primaryKey: true,
...
var User = db.define('user', userAttr);
var cartAttr = {
    qty: {
        type: sequelize_1.default.INTEGER,
        defaultValue: 1
...
var Cart = db.define('cart', cartAttr);
